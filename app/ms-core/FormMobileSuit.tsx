            ...
            <div className="col-span-1 flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                    ...
                    <div className="form-group col-span-1">
                        ...
                        <input type="text" value={formData.ms_cost} onChange={(e) => setFormData({ ...formData, ms_cost: e.target.value })} placeholder="Mobile Suit Cost" />
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                    <div className="form-group col-span-1">
                        <label htmlFor="ms_armor" className="px-2 mb-1 font-bold">Armor</label>
                        <input type="number" value={formData.ms_armor} onChange={(e) => setFormData({ ...formData, ms_armor: Number(e.target.value) })} placeholder="Mobile Suit Armor" />
                    </div>
                    <div className="form-group col-span-1">
                        <label htmlFor="ms_level" className="px-2 mb-1 font-bold">Level</label>
                        <input type="number" value={formData.ms_level} onChange={(e) => setFormData({ ...formData, ms_level: Number(e.target.value) })} placeholder="Mobile Suit Level" />
                    </div>
                    <div className="form-group col-span-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                    ...
                    <div className="form-group col-span-1">
                        ...
                        <input type="number" value={formData.ms_atk1dmg} onChange={(e) => setFormData({ ...formData, ms_atk1dmg: Number(e.target.value) })} placeholder="Mobile Suit Skill 1 DMG" />
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                    <div className="form-group col-span-2">
                    ...
                    <div className="form-group col-span-1">
                        ...
                        <input type="number" value={formData.ms_atk2dmg} onChange={(e) => setFormData({ ...formData, ms_atk2dmg: Number(e.target.value) })} placeholder="Mobile Suit Skill 2 DMG" />
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                    <div className="form-group col-span-2">
                    ...
                    <div className="form-group col-span-1">
                        ...
                        <input type="number" value={formData.ms_atk3dmg} onChange={(e) => setFormData({ ...formData, ms_atk3dmg: Number(e.target.value) })} placeholder="Mobile Suit Skill 3 DMG" />
                    </div>
                </div>
            </div>
        </div>
